...
"""Verify that starting jossd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jossd with -h for help text")
        ...
        self.log.info("Start jossd with -version for version information")
