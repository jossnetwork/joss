...
from test_framework.test_framework import JossTestFramework
...
class LLMQChainLocksTest(JossTestFramework):
    def set_test_params(self):
        self.set_joss_test_params(6, 5, fast_dip3_enforcement=True)
