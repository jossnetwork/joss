...
# TestP2PConn: A peer we use to send messages to jossd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes jossd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that jossd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for jossd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # jossd will not send blocktxn responses for blocks whose height is
