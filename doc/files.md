...
* joss.conf: contains configuration settings for jossd or joss-qt
* jossd.pid: stores the process id of jossd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by jossd or joss-qt
