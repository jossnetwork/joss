...
This document provides guidelines for internationalization of the Joss Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `joss_en.ts` remains unchanged.
