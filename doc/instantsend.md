...
This mechanism has been integrated into Bitcore-Node-Joss which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/jossnetwork/insight-api-joss#web-socket-api](https://github.com/jossnetwork/insight-api-joss#web-socket-api)
* API: [https://github.com/jossnetwork/insight-api-joss#instantsend-transactions](https://github.com/jossnetwork/insight-api-joss#instantsend-transactions)
