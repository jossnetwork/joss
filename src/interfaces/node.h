...
//! Interface for the src/evo part of a joss node (jossd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a joss node (jossd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a joss node (jossd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a joss node (jossd process).
class Node
{
public:
    virtual ~Node() {}
