...
void smartnode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the smartnode owner Joss address\n"
            "  payee          - Print the smartnode payout Joss address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the smartnode operator public key\n"
            "  status         - Print smartnode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the smartnode voting Joss address\n"
        );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "joss",               "smartnode",             &smartnode,             {} },
    { "joss",               "smartnodelist",         &smartnodelist,         {} },
};
