...
static void HASH_JOSS(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(BUFFER_SIZE,0);
    while (state.KeepRunning())
        hash = HashJoss(in.begin(), in.end());
}

static void HASH_JOSS_0032b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(32,0);
    while (state.KeepRunning())
...
static void HASH_JOSS_0080b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(80,0);
    while (state.KeepRunning())
...
static void HASH_JOSS_0128b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(128,0);
    while (state.KeepRunning())
...
static void HASH_JOSS_0512b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(512,0);
    while (state.KeepRunning())
...
static void HASH_JOSS_1024b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(1024,0);
    while (state.KeepRunning())
...
static void HASH_JOSS_2048b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(2048,0);
    while (state.KeepRunning())
...
BENCHMARK(HASH_JOSS_0032b_single, 70 * 1000);
BENCHMARK(HASH_JOSS_0080b_single, 65 * 1000);
BENCHMARK(HASH_JOSS_0128b_single, 60 * 1000);
BENCHMARK(HASH_JOSS_0512b_single, 50 * 1000);
BENCHMARK(HASH_JOSS_1024b_single, 50 * 1000);
BENCHMARK(HASH_JOSS_2048b_single, 50 * 1000);
