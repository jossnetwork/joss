...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04c7dff5f08967ab735e4470a7dd2cd451c9bf7cbcc025bf9a17e911b914e77e37b2eb1b2f84ce4fe38368f3434b68d1f77d2a39dd4696417406904d43d7fc41dd") << OP_CHECKSIG;
...
{
    CBlock block = CreateGenesisBlock(nTime, 0, nBits, 4, 1000 * COIN);
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 21600; // Note: actual number of blocks per calendar year with DGW v3 is ~200700 (for example 449750 - 249050)
        consensus.nSmartnodePaymentsStartBlock = 7200; //
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Joss: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Joss: 2 minutes
        ...
        consensus.smartnodePaymentFixedBlock = 7200;
        consensus.nFutureForkBlock = 420420;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008

        consensus.vDeployments[Consensus::DEPLOYMENT_V21].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nStartTime = 0; // 1717856226; // Saturday, June 8, 2024 2:17:06 PM
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nTimeout = 9999999999; // 1675206001; // Feb 01, 2023 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdStart = 3226; // 80% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdMin = 2420; // 60% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nFalloffCoeff = 5; // this corresponds to 10 periods

        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0"); 

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000718e0461c6c60045f39da02061735c643b4ebb55e05bb5741eb1044beef93"); 
        ...
        genesis = CreateGenesisBlock(1717771273, 4769, 0x20001fff, 4, 1000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa4d55c42cf94369da73fcb1a293b550da7b3dad0f2059c2ebca2a654d770d514"));
        assert(genesis.hashMerkleRoot == uint256S("0x06cde72d769ed5ab9da43f536072a1f14daab1fc2f289f601ba457ac6d991a2a"));

        vSeeds.emplace_back("seed.joss.network");



        // Joss addresses start with 'J'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,43);
        // Joss script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,102);
        // Joss private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,205);
        // Joss BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x03, 0x76, 0x13, 0x78};
        // Joss BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x03, 0x76, 0x13, 0xFD};
        // Joss BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"JZCr9VezB26y7RE31ij6vazqpMgrRVzXUu"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x000718e0461c6c60045f39da02061735c643b4ebb55e05bb5741eb1044beef93")},
            }
        };

        chainTxData = ChainTxData{
            1717771273,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Joss: 1 day
        consensus.nPowTargetSpacing = 60; // Joss: 1 minutes
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nStartTime = 1643670001; // Feb 01, 2022 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nTimeout = 1675206001; // Feb 01, 2023 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nWindowSize = 100;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdStart = 80;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdMin = 60;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nFalloffCoeff = 5; // this corresponds to 10 periods
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x003c6512ef9882d8a6954aa3ce02809df5c8f9a9ec06ab0b08be2c4c4e18779"); // 0
        ...
        genesis = CreateGenesisBlock(1717251426, 432, 0x20001fff, 4, 1000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe7910b18ba46e3c113b1f0923f14c1aeab5e16195ce27ce9048f4cc1e2a64749"));
        assert(genesis.hashMerkleRoot == uint256S("0x06cde72d769ed5ab9da43f536072a1f14daab1fc2f289f601ba457ac6d991a2a"));
        ...
        vSeeds.emplace_back("testnet.joss.network");
        //vSeeds.emplace_back("tnet1.joss.network", true);
        //vSeeds.emplace_back("tnet2.joss.network", true);

        // Testnet Joss addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Joss script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Joss BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Joss BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Joss BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nCollaterals = SmartnodeCollaterals(
          {  {30000, 200 * COIN}, {60000, 400 * COIN}, {INT_MAX, 600 * COIN}  },
          {  {INT_MAX, 45}  });

        consensus.nFutureRewardShare = Consensus::FutureRewardShare(0.8,0.2,0.0);

        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 5}  };// 5% founder/dev fee forever
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "TUtfKKzBYrcTAszStvBFLdHWvBFA1Ns6tr");
        ...
        vSporkAddresses = {"TTV6tgRXKY6kqAYpYN7mVNnAUj292bENes"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x003c6512ef9882d8a6954aa3ce02809df5c8f9a9ec06ab0b08be2c4c4e18779")},
            }
        };

        chainTxData = ChainTxData{
            1717251426, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Joss: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Joss: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nStartTime = 0; // Feb 01, 2022 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nTimeout = 9999999999ULL; // Feb 01, 2023 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nWindowSize = 100;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdStart = 80;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdMin = 60;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nFalloffCoeff = 5; // this corresponds to 10 periods
        ...
        genesis = CreateGenesisBlock(1716523204, 165567, 0x1e0ffff0, 4, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xae7374eb90ae01ff3c5f941597080188c33c46521720f83d8ca074644da6108a"));
        assert(genesis.hashMerkleRoot == uint256S("0xac6771de3203b1371f3a0a6a1fda495798d6faa08ef8fd0ec8132894f69384df"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("jossevo.org",  "devnet-seed.jossevo.org"));

        // Testnet Joss addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nStartTime = 0; // 1643670001; // Feb 01, 2022 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nTimeout = 9999999999ULL; // 1675206001; // Feb 01, 2023 00:00:01hrs
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nWindowSize = 100;
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdStart = 80; // 80% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nThresholdMin = 60; // 60% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_V21].nFalloffCoeff = 5; // this corresponds to 10 periods
        ...
        // Regtest Joss addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Joss script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Joss BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Joss BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Joss BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
