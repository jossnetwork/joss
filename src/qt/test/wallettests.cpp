...
//
//     src/qt/test/test_joss-qt -platform xcb      # Linux
//     src/qt/test/test_joss-qt -platform windows  # Windows
//     src/qt/test/test_joss-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: joss:")) != -1);
