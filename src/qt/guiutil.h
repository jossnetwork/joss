...
/** Utility functions used by the Joss Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "joss:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load joss specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a joss specific theme is activated (light/dark).*/
