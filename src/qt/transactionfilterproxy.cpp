...
bool TransactionFilterProxy::filterAcceptsRow(int sourceRow, const QModelIndex &sourceParent) const
{
    ...
    bool ijosssWatchAddress = index.data(TransactionTableModel::WatchonlyRole).toBool();
    if (ijosssWatchAddress && watchOnlyFilter == WatchOnlyFilter_No)
        return false;
    if (!ijosssWatchAddress && watchOnlyFilter == WatchOnlyFilter_Yes)
        return false;
