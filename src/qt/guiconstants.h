...
/* JossGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* JossGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Joss"
#define QAPP_ORG_DOMAIN "joss.network"
#define QAPP_APP_NAME_DEFAULT "Joss-Qt"
#define QAPP_APP_NAME_TESTNET "Joss-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Joss-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Joss-Qt-regtest"
