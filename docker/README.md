...
official/supported Docker Images found at https://hub.docker.com/r/joss/jossd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/joss/jossd-develop/ when changing the above text**