Contributing to Joss Core
============================

The Joss Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/jossnetwork/joss/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Joss Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Joss
Network Protocol consensus changes.

Whether a pull request is merged into Joss Core rests with the project merge
...
Patches that change Joss consensus rules are considerably more ijossd than
...
Where a patch set proposes to change the Joss consensus, it must have been
...
The review process is normally fairly responsive on the Joss Core repository, however
...
The project leader is the release manager for each Joss Core release.
