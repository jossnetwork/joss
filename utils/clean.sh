...
rm -rf test_bitcoin.coverage/ joss-gtest.coverage/ total.coverage/
...
clean_exe src/joss-cli
clean_exe src/jossd
clean_exe src/joss-gtest
clean_exe src/joss-tx
clean_exe src/test/test_joss
clean_exe src/test/test_joss_fuzzy
...
clean_dep . src/config/joss-config.h.in
